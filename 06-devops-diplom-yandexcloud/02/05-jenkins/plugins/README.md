Для правильной работы, образу нужно добавить плагины.

Ниже список, которые использовал. Все, кроме `git-parameter.jpi` установлены визардом.

Чтобы не засорять гит, я не стал их добавлять.

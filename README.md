...
Изменения внесены в тестовой ветке чтобы потом вержить в main 

### Слияние нескольких участников

Добавлено вроде как другим участником (со второй копии репозитория)

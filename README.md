...
| Windows системы для использования бухгалтерским отделом | физические сервера | Windows евозможно использовать в режимах паравиртуализации и виртуализации ОС. |
| Системы, выполняющие высокопроизводительные расчеты на GPU | виртуализация уровня ОС | если для проекта с GPU нужна виртуализация, то из предложенных возможна только уровня ОС |
